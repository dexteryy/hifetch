...
hifetch({
  ...
  // {
  //   "status": 5,
  //   "username": "[TIMEOUT ERROR] limit: 10000"
  // }
  // or
  // {
  //   "status": 1,
  //   "username": "[INTERNAL JS ERROR] error message that generated by Hifetch own code"
  //   "error": Error,
  // }
});
```
...
hifetch({
  ...
  // {
  //   "status": 3,
  //   "username": "[REMOTE ERROR] status: -1 message: INVALID TOKEN"
  //   "data": {
  //     "status": -1,
  //     "username": "INVALID QUERY"
  //   },
...
hifetch({
  ...
  // {
  //   "status": 2,
  //   "username": "[FETCH ERROR] 404 Not Found"
  //   "httpStatus": 404,
...
hifetch({
  ...
  // {
  //   "status": 4,
  //   "username": "[CUSTOM JS ERROR] error message that caused by user-defined hook function"
  //   "error": Error,
  // }
});
```
